        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
				...
				msg.contentMetadata = {'mid': mid}
				cl.sendMessage(msg)
				cl.sendText(msg.to,"Creator Zetsu PSD T&Z TEAM Bot")
            elif "Id" == msg.text:
                key = msg.to
			...
			kc.sendText(msg.to,cmid)
                ...
                ki.sendText(msg.to,"PŚĎ ßoŤ 1 +🛃 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"PŚĎ ßoŤ 2 +🛃 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"PŚĎ ßoŤ 3 +🛃 􀜁􀅔Har Har􏿿")
                kd.sendText(msg.to,"PŚĎ ßoŤ 4 +🛃 􀜁􀅔Har Har􏿿")
                ke.sendText(msg.to,"PŚĎ ßoŤ 5 +🛃 􀜁􀅔Har Har􏿿")
                kf.sendText(msg.to,"PŚĎ ßoŤ 6 +🛃 􀜁􀅔Har Har􏿿")
                kg.sendText(msg.to,"PŚĎ ßoŤ 7 +🛃 􀜁􀅔Har Har􏿿")
                kh.sendText(msg.to,"PŚĎ ßoŤ 8 +🛃 􀜁􀅔Har Har􏿿")
                kj.sendText(msg.to,"PŚĎ ßoŤ 9 +🛃 􀜁􀅔Har Har􏿿")
...
#========================================
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n [☸]➦Powered By: ZETSU•┅─────" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
				...
				if msg.from_ in admin:
					...
					for target in targets:
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    kq.kickoutFromGroup(msg.to,[target])
                                    print (msg.to,[g.mid])
                                except:
                                    kq.leaveGroup(msg.to)
                                    gs = cl.getGroup(msg.to)
